              ...
              <div className="relative h-full max-w-6xl m-auto px-6 sm:px-12">
                <div className="w-full sm:max-w-[61.8%] xl:max-w-[50%]">
                  ...
                  <div className="hidden sm:block md:text-lg 2xl:text-xl mt-6 space-y-6 sm:leading-snug prose">
                    <p>
                      We offer dangerous goods international shipping with
                      competitive export rates worldwide.
                    </p>
                  </div>
              ...
              <div className="w-full relative flex flex-wrap sm:flex-row gap-y-10 justify-between text-center sm:text-left">
                <div className="w-full sm:w-1/2 grid">
                  <div className="sm:pr-[6%] space-y-8">
                    <div className="leading-snug font-semibold text-black whitespace-pre-line text-2xl md:text-3xl">
                      <h2>
                        How do I know if my items are dangerous goods (DGs)?
                      </h2>
                    </div>
                    <div className="sm:text-lg prose marker:text-black marker:text-sm">
                      <p>
                        If you are shipping electronics, alcohol, scented
                        candles or even large amounts of hand sanitizers, your
                        items may be classified as Dangerous Goods.
                        <br />
                        <br />
                        In general, if your items are flammable, explosive,
                        corrosive, radioactive, or potentially environmentally
                        hazardous, they could be barred from shipping overseas.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="w-full sm:w-1/2 sm:mt-40 grid">
                  <div className="sm:pl-[6%] space-y-8">
                    <div className="leading-snug font-semibold text-black whitespace-pre-line text-2xl md:text-3xl">
                      <h3>
                        How can JustShip help with shipping dangerous goods
                        internationally?
                      </h3>
                    </div>
                    <div className="sm:text-lg prose marker:text-black marker:text-sm">
                      <p>
                        We know shipping dangerous goods overseas is
                        troublesome, so we’ll do all the boring bits.
                      </p>
                      <p>
                        We also partner with FedEx© to provide you with the
                        cheapest international moving rates – so it&#x27;s both
                        convenient &amp; affordable for you.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="relative h-full max-w-6xl m-auto px-6 sm:px-12">
              <div className="leading-snug text-center sm:text-left space-y-8 w-full">
                ...
                <div className="md:text-lg space-y-6 prose-ul:space-y-2 prose max-w-full md:prose-li:text-lg prose-li:text-left prose-li:mx-4 lg:prose-li:mx-8 prose-strong:text-inherit marker:text-black marker:text-sm">
                  <p>
                    A step-by-step process to shipping DGs (Dangerous Goods).
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="w-full">
                <div className="flex">
                  <div className="flex-1 flex relative">
                    <div
                      className="pb-4 w-full text-xl font-semibold text-dark-purple  border-b"
                      style={{ borderStyle: "solid", borderColor: "#6211cb" }}
                    >
                      <div className="mb-2">
                      ...
                      <div
                        className="absolute left-0 -bottom-1.5 w-3 h-3 rounded-full"
                        style={{ backgroundColor: "#6211cb" }}
                      ></div>
                    </div>
                  </div>
                  <div className="flex-1 flex relative">
                  ...
                  <div className="flex-1 flex relative">
                    <div
                      className="pb-4 w-full text-xl font-semibold text-dark-purple "
                      style={{ borderStyle: "solid", borderColor: "#6211cb" }}
                    >
                      <div className="mb-2">
                        <div className="w-[18px] h-auto">
                ...
                <div className="flex">
                  ...
                  <div className="flex-1 flex">
                    <div className="w-[80%] pt-8 leading-snug prose">
                      <p>
                        Once the DG is approved for shipping by our DG
                        Specialist, we will provide a quote for your shipment.
                        <br />
                        <br />
                  ...
                  <div className="flex-1 flex">
                    <div className="w-[80%] pt-8 leading-snug prose">
                      <p>
                        Have your parcels picked up by our couriers, or drop it
                        off at our office yourselves!
                      </p>
                    </div>
                  </div>
                </div>
                        ...
                        <div className="flex whitespace-pre-line gap-x-1">
                          ...
                          <div className="-mt-1 ml-2 pb-10">
                            ...
                            <div className="mt-4 leading-snug prose">
                              <p>
                                Once the DG is approved for shipping by our DG
                                Specialist, we will provide a quote for your
                                shipment.
                                <br />
                                <br />
                                To proceed, fill up our
                      ...
                      >
                        ...
                        <div className="flex whitespace-pre-line gap-x-1">
                          ...
                          <div className="-mt-1 ml-2 pb-10">
                            ...
                            <div className="mt-4 leading-snug prose">
                              <p>
                                Have your parcels picked up by our couriers, or
                                drop it off at our office yourselves!
                              </p>
                            </div>
                          </div>
                        </div>

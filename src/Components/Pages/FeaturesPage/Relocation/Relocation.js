...
const Relocation = () => {
  const [faqs, setFaqs] = useState([
    ...
    },
    {
      ...
      answer:
        "When you choose JustShip, you choose the hassle free option that saves your time, energy and headspace for what matters most to you.",
      open: false,
    },
    {
      question: "I am returning a product",
      answer:
        "Self-ship your returns, cheap and hassle-free. Get more fees refunded when you return to sellers fast with JustShip, and save time with our packing and tracked shipping that complies with seller policies.",
      open: false,
    },
    {
      question: "I am living abroad and need to ship to myself",
      answer:
        "Use JustShip to cut the hassle out of the process so you can get the job done efficiently without inconveniencing you or your family.",
      open: false,
    },
    {
      question: "I am selling e-commerce products overseas",
      answer:
        "Keep costs tightly under control while watching your customers’ satisfaction and retention skyrocket when you use JustShip. Grow your business by drawing on demand from the entire globe. WhatsApp us to get started!",
      open: false,
    },
    {
      question: "I am sending samples to prospects",
      answer:
        "Strike while the iron is hot - get your samples shipped quickly and affordably with JustShip. Impress your prospects with a superb sample experience and earn yourself more sales.",
      open: false,
    },
  ]);
      ...
      <main>
        <div className="bg-[#E5E5E5]">
          <div
            style={{
              backgroundImage:
                "url(https://cdn.sanity.io/images/bm4duuk0/production/10ca250bbcc7f5df17c47b24521a19e273d5b7c2-1440x758.jpg?fit=max&amp;auto=format)",
          ...
          >
            <div
              ...
              style={{
                background: "linear-gradient(to right, #fed430, #5c65f7)",
              }}
            ></div>
              ...
              <div className="relative h-full max-w-6xl m-auto px-6 sm:px-12">
                <div className="w-full sm:max-w-[61.8%] xl:max-w-[50%]">
                  ...
                  <div className="hidden sm:block md:text-lg 2xl:text-xl mt-6 space-y-6 sm:leading-snug prose">
                    ...
                    <p>
                      Save your time, energy and headspace for what matters most
                      to you.
                    </p>
                  </div>
                    ...
                    >
                      <button className="group bg-transparent text-lg text-white hover:text-gray-200 font-semibold sm:hidden">
                        ...
                        <svg
                          ...
                          fill="#25D366"
                          className="ml-4 inline w-[32px] h-auto group-hover:fill-[#22BF5B]"
                        >
                          <g>
          ...
          <div className="bg-cover bg-center block sm:hidden py-10 text-center bg-white">
            <div className="relative h-full max-w-6xl m-auto px-6 sm:px-12">
              <div className="leading-snug space-y-6 prose">
                ...
                <p>
                  Save your time, energy and headspace for what matters most to
                  you.
                </p>
              </div>
            </div>
              ...
              <div className="w-full">
                <div className="grid grid-cols-2">
                  ...
                  <div className="col-span-full sm:col-span-1 pt-8 pb-12 px-[6%] sm:pl-[9%] sm:pr-[18%] md:border-b border-[#6211cb] space-y-10 leading-snug prose md:text-lg">
                    <p>
                      <strong>No more waiting</strong> indefinitely for quotes.
                      Get an
                      <a href="/get-a-quote">instant estimate</a>.
                    </p>
                    <p>
                      <strong>Ask us anything</strong> regarding your move!
                      We’ll respond within 1 work day.
                    </p>
                    <p>
                      <strong>Save headspace</strong>
          ...
          <div
            style={{
              backgroundImage:
                "url(https://cdn.sanity.io/images/bm4duuk0/production/65c514282a1f4f253ae94f7cebf125162187673a-1440x598.jpg?fit=max&amp;auto=format)",
              backgroundPosition: "center",
            }}
            className="relative h-[280px] bg-cover bg-left sm:bg-center shadow sm:h-[50vh] sm:max-h-[540px] lg:h-[60vh] 2xl:max-h-[45vh]"
          >
            <div className="bg-cover bg-center pt-8 md:pt-12 pb-8 md:pb-12 text-center sm:text-left h-full">
              <div className="relative h-full max-w-6xl m-auto px-6 sm:px-12">
                <div className="w-full sm:max-w-[61.8%] xl:max-w-[50%]">
                  <div className="text-2xl sm:text-3xl md:text-4xl xl:text-4.5xl font-semibold leading-snug sm:leading-snug xl:leading-tight whitespace-pre-line"></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-cover bg-center pt-12 md:pt-16 pb-16 md:pb-24">
            <div className="relative h-full max-w-6xl m-auto px-6 sm:px-12">
              <div
                className="mb-8 lg:mb-12 leading-snug font-bold text-xl md:text-3xl scroll-mt-20"
                id="What else are you looking for today?"
              >
                <p>
                      ...
                      <div>
                        ...
                        >
                          <p>
                            {faq.answer}
                            <a
                              className="text-[#844FFA] hover:text-[#844FFA]"
                              target="_blank"
                                ...
                                <div className="h-full">
                                  ...
                                  <div className="line-clamp-[12]">
                                    <p className="text-sm md:text-[11px] md:leading-4 text-[rgb(60,64,67)] font-[&#x27;Arial&#x27;] text-left">
                                      ...
                                      days for him to receive it! Affordable and
                                      fast. The customer service was splendid as
                                      well. The person who came to pick the
                                      package up was really nice and
                                      understanding even though I was in a work
                                      meeting (Pick up is free). The tracking
                                      was smooth too! Thank you so much!!
                                    </p>
                                  </div>
                                </div>
                              </a>
          ...
          <div className="bg-cover bg-center pt-8 md:pt-12 pb-8 md:pb-12">
            <div className="relative h-full max-w-6xl m-auto px-6 sm:px-12">
              <div className="leading-snug text-center sm:text-left space-y-8 w-full">
                <div className="leading-snug font-semibold text-2xl md:text-3xl">
                  <h2>
                    Have your items seamlessly delivered in less than 2 weeks.
                  </h2>
                </div>
                <div className="md:text-lg space-y-6 prose-ul:space-y-2 prose max-w-full md:prose-li:text-lg prose-li:text-left prose-li:mx-4 lg:prose-li:mx-8 prose-strong:text-inherit marker:text-black marker:text-sm">
                  <p>
                    ...
                    <strong>free pick-up</strong> from your doorstep and
                  ...
                  <p>
                    Your items can be out of your house and in a plane in less
                    than a week, then add just another week to have it reach the
                    doorstep of your destination.
                  </p>
                </div>

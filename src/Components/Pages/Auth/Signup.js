     ...
     <div className="lg:w-1/2 xl:max-w-screen-sm mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                    ...
                    <div className="mt-12">
                        ...
                        <div  className='lg:flex  gap-4 justify-between items-center max-w-full'>
                               <div className='mb-4'>
                               <div className="text-sm font-bold text-gray-700 tracking-wide text-left">First Name</div>
                                <input  {...register("fname", {
                    required: {
                      value: true,
                      message: "First Name is required"
                    }
                  })}  className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" placeholder=""/>
                  ...
                  {errors.fname?.type === 'required' && <span className="label-text-alt  text-red-500">{errors.fname.message}</span>}
                               ...
                               <div className='mb-4'>
                               <div className="text-sm font-bold text-gray-700 tracking-wide text-left ">Last Name</div>
                                <input className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" placeholder=""  {...register("lname", {
                    required: {
                      value: true,
                  ...
                  {errors.lname?.type === 'required' && <span className="label-text-alt  text-red-500">{errors.lname.message}</span>}
                            ...
                            <div className='mb-4'>
                                ...
                                <input className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" placeholder=""{...register("email", {
                    required: {
                      value: true,
                  ...
                  {errors.email?.type === 'pattern' && <span className="label-text-alt  text-red-500">{errors.email.message}</span>}
                            ...
                            <div className="mt-8">
                                ...
                                <input className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" placeholder="Enter your password" {...register("password", {
                    required: {

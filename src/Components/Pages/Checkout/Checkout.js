            ...
            <div className="w-[85%] md:w-[75%] lg:w-[65%] mx-auto text-sm ">
              ...
              <div className="flex flex-wrap my-8 justify-center gap-6 md:gap-8 ">
                ...
                <button
                  type="button"
                  id="pickup-button"
                  className={`pill-button button-hover flex justify-center items-center group w-[140px] lg:w-[160px] h-[40px] ${
                    selected === "pickup" ? "bg-light-purple  text-white" : ""
                  }`}
                ...
                <button
                  ...
                  id="dropoff-button"
                  className={`pill-button button-hover flex justify-center items-center group w-[140px] lg:w-[160px] h-[40px] ${
                    selected === "dropoff" ? "bg-light-purple  text-white" : ""
                  }`}
                ...
                >
                  <svg
                    ...
                    height="20"
                    viewBox="0 0 24 24"
                    className="stroke-dark-purple mr-1"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path

                ...
                >
                  <div className="relative flex items-center h-full z-[2] w-full">
                    <input
                      ...
                      type="text"
                      defaultValue="Master Recieve"
                    />
                  </div>
                  <p className="min-h-[1rem] text-xs text-error-red absolute top-10 mt-0.5 ml-0.5 ">
                    Required
                  </p>
                </div>
              </div>
              ...
              <div className="w-full flex flex-col group">
                ...
                >
                  <svg
                    ...
                    className="w-[18px] inline-block absolute right-0 mr-2 w-[18px] group-focus-within:invisible stroke-dark-purple z-[2]"
                  >
                    <circle
                      r="10"

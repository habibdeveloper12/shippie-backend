...
const Package = () => {
  ...
  for (let i = 0; i <= 10; i++) {
    ...
    let dateString = date.toLocaleString('en-US', { weekday: 'short', month: 'short', day: 'numeric' });
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      />
      <label className="text-sm font-bold text-gray-500">When do you want to ship?</label>
      <select

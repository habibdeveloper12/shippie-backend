...
const item = { quantity: 0, describe: "", category: "", value: 0, weight: 0 }
...
const PackageForm = () => {
    ...
    const { register, formState: { errors }, setValue, clearErrors, control, watch } = methods;
    const { fields, append, remove } = useFieldArray({ name: "packages", control });

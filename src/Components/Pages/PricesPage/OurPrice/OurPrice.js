        ...
        <div className="bg-[#E5E5E5]">
          <div>
            <div
              style={{
                backgroundImage:
                  "url(https://cdn.sanity.io/images/bm4duuk0/production/4b3e132019965a2a6d3a1fda07efb0bd05f66953-1440x758.png?fit=max&amp;auto=format)",
                backgroundPosition: "center",
              }}
              className="relative h-[280px] bg-cover bg-left sm:bg-center shadow sm:h-[50vh] sm:max-h-[540px] lg:h-[60vh] 2xl:max-h-[45vh]"
            >
              <div
                className="absolute inset-0 opacity-75 md:opacity-50"
                style={{
                  background: "linear-gradient(to right, #ffc3a7, #5c65f7)",
                }}
              ></div>
                    ...
                    <div className="hidden md:block md:text-lg 2xl:text-xl md:mt-6 space-y-6 leading-snug prose text-white text-inherit">
                      <p>
                        <span style={{ color: "#ffffff" }}>
                          Same-day shipping.
                          <br />
                          All packages will be delivered within 2-5 working
                          days.
                        </span>
                      </p>
                    </div>
                    ...
                    <div className="sm:pr-[6%] space-y-8">
                      ...
                      <div className="sm:text-lg prose marker:text-black marker:text-sm">
                        <p>
                          ...
                          With JustShip, sending a parcel to USA has never been
                          cheaper or easier. Simply get a quote, and if it is
                          within your budget, submit our shipping form! We offer
                          free next weekday pick-up. You won’t even need to
                          print any labels, just make sure your Order ID is
                          indicated somewhere on the parcel and we’ll do the
                          rest!
                        </p>
                        <p></p>
                        <p>
                          <strong>
                            <span style={{ color: "#6211cb" }}>
                              Cheapest Courier Service to USA
                            </span>
                          </strong>
                          <br />
                          <br />
                          We offer the cheapest shipping from Singapore to USA,
                          amongst many other local courier services. Our
                          delivery time takes 2 -5 working days. Not only are we
                          the cheapest, but we are also the fastest.
                          <br />
                          <br />
                ...
                <tbody>
                  <tr className="border-y border-[#611ECB] text-xs md:text-base">
                    <td className="py-2 md:px-4">
                      <p className="w-min pr-2 md:pr-0">JustShip</p>
                    </td>
                    <td className="py-2 px-2 md:px-4">
                      <p className="md:whitespace-nowrap">2 - 5 Days</p>
                    </td>
                    <td className="py-2 px-2 md:px-4">
                      <p className="">$72.91</p>
                    </td>
                  ...
                  <tr className="border-y border-[#611ECB] text-xs md:text-base">
                    <td className="py-2 md:px-4">
                      <p className="w-min pr-2 md:pr-0">
                        Singpost (Speedpost Express)
                      </p>
                    </td>
                    <td className="py-2 px-2 md:px-4">
                      <p className="md:whitespace-nowrap">6 Days</p>
                    </td>
                    <td className="py-2 px-2 md:px-4">
                      <p className="">$159.00</p>
                    </td>
                  </tr>
                  <tr className="border-y border-[#611ECB] text-xs md:text-base">
                    <td className="py-2 md:px-4">
                      <p className="w-min pr-2 md:pr-0">DHL</p>
                    </td>
                    <td className="py-2 px-2 md:px-4">
                      <p className="md:whitespace-nowrap">3 - 4 Days</p>
                    </td>
                    <td className="py-2 px-2 md:px-4">
                  ...
                  <tr className="border-y border-[#611ECB] text-xs md:text-base">
                    ...
                    <td className="py-2 px-2 md:px-4">
                      <p className="md:whitespace-nowrap">1 - 3 Days</p>
                    </td>
                    <td className="py-2 px-2 md:px-4">
                      <p className="">$504.00</p>
                    </td>
                  </tr>
                </tbody>
              </table>
                      ...
                      <table className="border-collapse border-y border-[#611ECB] text-sm md:text-base w-full">
                        <thead className="text-left align-top">
                          <tr>
                            ...
                            <th className="py-2 px-2 md:px-4">
                              <p className="my-1">What can I ship</p>
                            </th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr className="border-y border-[#611ECB] text-xs md:text-base">
                            <td className="py-2 px-2 md:px-4">
                              <p className="max-w-max pr-2 md:pr-0 my-1">1kg</p>
                            </td>
                            <td className="py-2 px-2 md:px-4">
                              <p className="max-w-max pr-2 md:pr-0 my-1">
                                $55.82
                              </p>
                            </td>
                            <td className="py-2 px-2 md:px-4">
                          ...
                          <tr className="border-y border-[#611ECB] text-xs md:text-base">
                            <td className="py-2 px-2 md:px-4">
                              <p className="max-w-max pr-2 md:pr-0 my-1">5kg</p>
                            </td>
                            <td className="py-2 px-2 md:px-4">
                              <p className="max-w-max pr-2 md:pr-0 my-1">
                                $129.29
                    ...
                    <div className="sm:pr-[6%] space-y-8">
                      ...
                      <div className="sm:text-lg prose marker:text-black marker:text-sm">
                        <p>
                          ...
                          <br />
                          With JustShip, sending a parcel to Malaysia has never
                          been cheaper or easier. Simply get a quote, and if it
                          is within your budget, submit our shipping form! We
                          offer free next weekday pick-up. You won’t even need
                          to print any labels, just make sure your Order ID is
                          indicated somewhere on the parcel and we’ll do the
                          rest!
                        </p>
                        <p></p>
                        <p>
                          <strong>
                            <span style={{ color: "#6211cb" }}>
                              Cheapest Courier Service to Malaysia
                            </span>
                          </strong>
                          <br />
                          <br />
                          We offer the cheapest shipping from Singapore to
                          Malaysia, amongst many other local courier services.
                          Our delivery time takes 2 – 5 working days. Not only
                          are we the cheapest, but we are also the fastest.
                          <br />
                          <br />
                          Don’t believe us? Check this out.
                        </p>
            ...
            <div className="bg-cover bg-center pt-8 md:pt-12 pb-8 md:pb-12">
              <div className="relative h-full max-w-6xl m-auto px-6 sm:px-12">
                <div className="leading-snug text-center sm:text-left space-y-8 w-full">
                  <div className="leading-snug font-semibold text-2xl md:text-3xl">
                    <h3>
                      Price Comparison - Shipping Cost From Singapore to
                      Malaysia
                    </h3>
                  </div>
                </div>
              ...
              <table className="border-collapse border-y border-[#611ECB] text-sm md:text-base w-full table-fixed">
                ...
                <tbody>
                  ...
                  <tr className="border-y border-[#611ECB] text-xs md:text-base">
                    ...
                    <td className="py-2 px-2 md:px-4">
                      <p className="md:whitespace-nowrap">2 - 3 Days</p>
                    </td>
                    <td className="py-2 px-2 md:px-4">
                      <p className="">$61.00</p>
                    </td>
              ...
              <div className="relative h-full max-w-6xl m-auto px-6 sm:px-12">
                <div className="leading-snug text-center sm:text-left space-y-8 w-full">
                  <div className="md:text-lg md:space-y-6 space-y-2  max-w-full  marker:text-sm">
                    <p>
                      While driving to Malaysia does seem to be the most obvious
                      option, air shipping is still the cheapest way for a few
                      reasons:
                    </p>
                    <ol type="A">
                      <li className=" mb-3 flex  ml-8">
                        <h1 className=" mr-2">1. </h1>
                        <strong>Time.</strong> It takes time to drive up, and
                        you could use that time for something else. Especially
                        if you get caught in the causeway jam!
                      </li>
                      <li className=" mb-3 flex  ml-8">
                        <h1 className=" mr-2">2. </h1>
                        <strong>Petrol.</strong> Yes, it’s cheaper there, but
                        wouldn’t it be better to just save on the extra cost and
                        deliver it straight from your doorstep?
                      </li>
                      <li className=" mb-3 flex  ml-8">
                        <h1 className=" mr-2">3. </h1>
                        <strong>You need a car.</strong>
                        Using FedEx International Priority means we use planes –
                        cheap and fast shipping to Malaysia!
                      </li>
                    </ol>
                  </div>
                </div>
                                  ...
                                  <div className="h-full">
                                    ...
                                    <div className="line-clamp-[12]">
                                      <p className="text-sm md:text-[11px] md:leading-4 text-[rgb(60,64,67)] font-[&#x27;Arial&#x27;] text-left">
                                        Had a hard time finding an affordable
                                        shipping option but I luckily found
                                        JustShip! First time shipping a package
                                        all the way to Sharjah, UAE for my
                                        boyfriend’s birthday and it took just 3
                                        days for him to receive it! Affordable
                                        and fast. The customer service was
                                        splendid as well. The person who came to
                                        pick the package up was really nice and
                                        understanding even though I was in a
                                        work meeting (Pick up is free). The
                                        tracking was smooth too! Thank you so
                                        much!!
                                      </p>
                                    </div>
                                  </div>
                              ...
                              <div className="carousel__cell w-[70%] max-w-[270px] md:max-w-full md:w-[198px] h-[315px] sm:h-[320px] md:h-[261px] px-2 py-2 top-[50%] -translate-y-[50%] left-0 right-0 mx-auto text-ellipsis overflow-hidden translate-x-96 lg:translate-x-28 opacity-0 lg:opacity-100 z-[1] pointer-events-none">
                                ...
                                >
                                  <div className="h-full">
                                    ...
                                    <div className="line-clamp-[12]">
                                      <p className="text-sm md:text-[11px] md:leading-4 text-[rgb(60,64,67)] font-[&#x27;Arial&#x27;] text-left">
                                        Have used them twice so far and the
                                        experience has been great! Affordable
                              ...
                              <div className="carousel__cell w-[70%] max-w-[270px] md:max-w-full md:w-[198px] h-[315px] sm:h-[320px] md:h-[261px] px-2 py-2 top-[50%] -translate-y-[50%] left-0 right-0 mx-auto text-ellipsis overflow-hidden -translate-x-96 lg:-translate-x-28 opacity-0 lg:opacity-100 z-[2] pointer-events-none">
                                ...
                                >
                                  <div className="h-full">
                                    ...
                                    <div className="line-clamp-[12]">
                                      <p className="text-sm md:text-[11px] md:leading-4 text-[rgb(60,64,67)] font-[&#x27;Arial&#x27;] text-left">
                                        Shipment arrived very promptly and with
                                        very cheap and good service overall!
                                      </p>
                                    </div>
                                  </div>
                                </a>
